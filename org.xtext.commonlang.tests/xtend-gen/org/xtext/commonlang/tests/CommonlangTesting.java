...
public class CommonlangTesting {
  ...
  public void testInvalidValues() {
    try {
      ...
      this._validationTestHelper.assertError(sc, _negNumberValue, "org.eclipse.xtext.diagnostics.Diagnostic.Syntax", "mismatched input \'false\' expecting RULE_INT");
      EClass _assignment_1 = CommonlangPackage.eINSTANCE.getAssignment();
      this._validationTestHelper.assertError(sc, _assignment_1, null, "Type mismatch: Expected boolean got int");
      EClass _assignment_2 = CommonlangPackage.eINSTANCE.getAssignment();
      this._validationTestHelper.assertError(sc, _assignment_2, null, "Type mismatch: Expected string got int");
