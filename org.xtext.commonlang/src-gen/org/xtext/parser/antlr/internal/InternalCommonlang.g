...
(
    ...
    { 
        $current = $this_MetaMethods_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(
    ...
    { 
        $current = $this_BasicValue_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
